  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm text-(--color-text-secondary) uppercase tracking-wide mb-1">Sale Invoice</p>
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" onClick={() => router.push(`${ROUTES.SALE_INVOICES}/${id}/edit`)}>Edit</Button>
        ...
        <table className="w-full text-sm">
          <thead className="bg-(--color-bg-secondary)">
            <tr>
              ...
              <th className="text-left px-4 py-3 text-(--color-text-secondary) font-semibold">Serial #</th>
          ...
          <tbody>
            {(invoice.items || []).map((li, idx) => (
              <tr key={li.id} className={[
                ...
                <td className="px-4 py-3 text-(--color-text-secondary) font-mono text-xs tracking-wide">
                  {li.serialNumber || '—'}
                </td>
