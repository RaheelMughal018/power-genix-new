...
describe('UpdateUserProvider', () => {
  ...
  it('should update user firstName successfully', async () => {
    ...
    mockQueryRunner.manager.save.mockResolvedValue({ ...user, firstName: 'Jane' });

    const result = await provider.execute({ firstName: 'Jane' }, activeUser);
  ...
  it('should keep existing firstName when firstName is undefined', async () => {
    const user = { ...existingUser };
    mockQueryRunner.manager.findOne.mockResolvedValue(user);
  ...
  it('should look up user by activeUser.id', async () => {
    ...
    await provider.execute({ firstName: 'Jane' }, activeUser);
  ...
  it('should throw UnauthorizedException when user not found', async () => {
    ...
    await expect(
      provider.execute({ firstName: 'Jane' }, activeUser),
